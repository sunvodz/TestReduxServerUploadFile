  ...
  return (dispatch) => { // optionally you can have getState as the second argument
    ...
    const promise = new Promise((resolve, reject) => {
      ...
      doRequest.then(
        (res) => {
          dispatch({
            type: ASSETS_SEND_REQUEST_SUCCESS,
            data: res,
          });
          resolve(res);
        },
        ...
        (err) => {
          dispatch({
            type: ASSETS_SEND_REQUEST_FAILURE,
            data: { error: err },
          });
          reject(err);
        },
...
export function dismissSendRequestError() {
  return {
...
export function reducer(state, action) {
  switch (action.type) {
    case ASSETS_SEND_REQUEST_BEGIN:
    ...
    case ASSETS_SEND_REQUEST_SUCCESS:
    ...
    case ASSETS_SEND_REQUEST_FAILURE:
      // The request is failed
      return {
        ...state,
        sendRequestPending: false,
        sendRequestError: action.data.error,
      };

    case ASSETS_SEND_REQUEST_DISMISS_ERROR:
